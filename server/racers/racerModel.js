...
var RacerSchema = new mongoose.Schema({
  ...
  modList: {
    ...
    default: {
      ...
      {name: 'OEM ECU reflash on a car with OEM intake & exhaust parts', value: 0, active: false},
      {name: 'Aftermarket ECU, or OEM ECU reflash on a car with any non-OEM intake or exhaust parts', value: 0.5, active: false},
      {name: 'Use of E85 gas', value: 0.5, active: false},
      ...
      {name: 'Level 1 R-compound tire (100TW)', value: 0.5, active: false},
      {name: 'Bridgestone RE-71R or BFGoodrich Rival-S', value: 2, active: false},
